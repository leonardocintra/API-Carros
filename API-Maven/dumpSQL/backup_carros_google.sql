...
--
-- Current Database: `livro`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `livro` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT INTO `innodb_index_stats` VALUES ('livro','carro','PRIMARY','2015-06-13 16:28:52','n_diff_pfx01',30,1,'id'),('livro','carro','PRIMARY','2015-06-13 16:28:52','n_leaf_pages',1,NULL,'Number of leaf pages in the index'),('livro','carro','PRIMARY','2015-06-13 16:28:52','size',1,NULL,'Number of pages in the index');
...
INSERT INTO `innodb_table_stats` VALUES ('livro','carro','2015-06-13 16:28:52',30,1,0);
...
INSERT INTO `proxies_priv` VALUES ('localhost','root','','',1,'','2015-06-13 15:09:00');
